...
namespace Engine
{
	...
	public:
		...
		Camera();
		Camera(glm::vec3 position, glm::vec3 pointCible, glm::vec3 axeVertical, float sensibilite, float vitesse, FrustrumCulling* frustrumCulling);
		~Camera();
	...
	private:
		...
		FrustrumCulling* m_frustrumCulling;
	};
}
#endif
