...
Camera::Camera(glm::vec3 position, glm::vec3 pointCible, glm::vec3 axeVertical, float sensibilite, float vitesse, FrustrumCulling* frustrumCulling) : m_phi(0.0), m_theta(0.0), m_orientation(),
                                                                                                                    ...
                                                                                                                    m_frustrumCulling(frustrumCulling)
{
    m_frustrumCulling->setFrustrumCulling(m_position, m_pointCible);
}
